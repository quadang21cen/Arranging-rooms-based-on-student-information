...
class TF_IDF:
    def __init__(self) -> None:
        self.stopwords_path = "C:\\Users\\quach\\Desktop\\Personal\\FPT University\\SEMESTER 9\\Arranging-rooms-based-on-student-information\\Recomender\\TF_IDF\\vietnamese_stopwords.txt"
...
# corpus = ["tôi  thích bơi lội,nghe nhạc, và đọc sách chơi đá bóng",
#             "Toi thich đàn"]   
# tf_idf = TF_IDF()
# vect, tfidf = tf_idf.transform_vector(corpus)

# import pandas as pd
# vec = tf_idf.text2vec(corpus)
# print(vec[1])


#feature_df = pd.DataFrame(tf_idf.text2vec(corpus),columns=vect.get_feature_names_out())
# print(feature_df[0])
